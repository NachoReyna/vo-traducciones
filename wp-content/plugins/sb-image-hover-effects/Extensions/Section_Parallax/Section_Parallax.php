...
namespace SA_EL_ADDONS\Extensions\Section_Parallax;

/**
 * Description of Parallax_Section
 *
 * @author Jabir
 */
if (!defined('ABSPATH')) {
...
class Section_Parallax {
    ...
    public function __construct() {
        ...
        add_filter('sael/section/after_render', function ($extensions) {
            $extensions[] = 'sael-section-parallax';
            return $extensions;
        });
    }
    ...
    public function register_controls($element) {
        ...
        $element->start_controls_section('sa_el_section_parallax',
                [
                    'label' => __('OXI Parallax', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $element->add_control('sa_el_parallax_switcher',
                [
                    'label' => __('Enable Parallax', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $element->add_control('sa_el_parallax_type',
                [
                    ...
                    'options' => [
                        ...
                        'scroll-opacity' => __('Scroll with Fade', SA_EL_ADDONS_TEXTDOMAIN),
                        'opacity' => __('Fade', SA_EL_ADDONS_TEXTDOMAIN),
                        'scale' => __('Zoom', SA_EL_ADDONS_TEXTDOMAIN),
                        'scale-opacity' => __('Zoom with Fade', SA_EL_ADDONS_TEXTDOMAIN),
                        'automove' => __('In-Motion', SA_EL_ADDONS_TEXTDOMAIN),
                        'multi' => __('Multi-Layered', SA_EL_ADDONS_TEXTDOMAIN)
                    ],
                    'label_block' => 'true',
                    'condition' => [
                        'sa_el_parallax_switcher' => 'yes'
        ...
        $repeater->add_control('sa_el_parallax_layer_mouse',
                [
                    'label' => esc_html__('Mouse Hover Interaction', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes'
                ]
        );
        ...
        $repeater->add_control('sa_el_parallax_layer_rate',
                [
                    'label' => esc_html__('Moving Intensity', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $repeater->add_control('sa_el_parallax_layer_hor_pos',
                [
                    'label' => esc_html__('Horizontal Position', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 50,
                    'min' => 0,
                    'max' => 100
        ...
        $repeater->add_control('sa_el_parallax_layer_ver_pos',
                [
                    'label' => esc_html__('Vertical Position', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 50,
                    'min' => 0,
                    'max' => 100,
        ...
        $repeater->add_control('sa_el_parallax_layer_back_size',
                [
                    'label' => esc_html__('Image Size', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'auto',
                    'options' => [
                        'auto' => esc_html__('Auto', SA_EL_ADDONS_TEXTDOMAIN),
                        'cover' => esc_html__('Cover', SA_EL_ADDONS_TEXTDOMAIN),
                        'contain' => esc_html__('Contain', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                ]
        );
        ...
        $element->add_control('sa_el_parallax_auto_type',
                [
                    'label' => __('Motion Direction', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 11,
                    'options' => [
                        11 => __('Left to Right', SA_EL_ADDONS_TEXTDOMAIN),
                        'right' => __('Right to Left', SA_EL_ADDONS_TEXTDOMAIN),
                        'top' => __('Top to Bottom', SA_EL_ADDONS_TEXTDOMAIN),
                        'bottom' => __('Bottom to Top', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    'condition' => [
        ...
        $element->add_control('sa_el_parallax_speed',
                [
                    'label' => __('Parallax Speed', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::NUMBER,
                    'min' => -1,
                    'max' => 2,
                    'step' => 0.1,
        ...
        $element->add_control('sa_el_auto_speed',
                [
                    'label' => __('Motion Speed', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 4,
                    'min' => 0,
                    'max' => 150,
        ...
        $element->add_control('sa_el_parallax_android_support',
                [
                    'label' => esc_html__('Parallax on Android Devices', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'sa_el_parallax_type!' => ['automove', 'multi'],
                        'sa_el_parallax_switcher' => 'yes'
        ...
        $element->add_control('sa_el_parallax_ios_support',
                [
                    'label' => esc_html__('Parallax on iOS Devices', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'sa_el_parallax_type!' => ['automove', 'multi'],
                        'sa_el_parallax_switcher' => 'yes'
    ...
    public function after_render($element) {
        ...
        if ('section' === $type && isset($parallax) && '' !== $parallax && 'yes' === $element->get_settings('sa_el_parallax_switcher')
            ...
            <?php if ('automove' != $parallax && 'multi' != $parallax) : ?>
                        ...
                        var SAELParallaxElement = {

                            init: function () {
                                elementorFrontend.hooks.addAction('frontend/element_ready/global', SAELParallaxElement.initWidget);
                            },
                            ...
                            initWidget: function ($scope) {
                                ...
                                target.jarallax({
                                    ...
                                    keepImg: true,
                                    disableParallax: SAELParallaxElement.responsiveParallax(),
                                });
                            }

                        };

                        $(window).on('elementor/frontend/init', SAELParallaxElement.init);
                        ...
                        if ($(window).outerWidth() > <?php echo esc_js(Responsive::get_breakpoints()['md']); ?>) {
                            ...
                            $('.elementor-element-<?php echo $element->get_id(); ?>').mousemove(function (e) {
                                ...
                                $(this).find('.sa-el-parallax-layer[data-parallax="true"]').each(function (index, element) {
                                    ...
                                    $(this).saelparallax($(this).data('rate'), e);
