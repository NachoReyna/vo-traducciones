(function ($, w) {
    'use strict';
    $.fn.saelparallax = function (resistance, mouse) {
        var $el = $(this);
        TweenLite.to($el, 0.2, {
    ...
    var SAELParallaxElement = function ($scope, $) {
        var target = $scope,
                ...
                if (2 < index) {
                    if (
                        ...
                        var backgroundImage =
                                ...
                                .css({
                                    "z-index":
                                            layout["sa_el_parallax_layer_z_index"],
                                    "background-image":
                                            "url(" + backgroundImage + ")",
                                    "background-size":
                                            layout["sa_el_parallax_layer_back_size"],
