...
namespace SA_EL_ADDONS\Elements\Info_Box;
...
class Info_Box extends Widget_Base
{
    ...
    {
        return esc_html__('Info Box', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Infobox Image', SA_EL_ADDONS_TEXTDOMAIN)
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Infobox Type', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'img-on-top',
                'label_block' => false,
                'options' => [
                    'img-on-top' => esc_html__('Image/Icon On Top', SA_EL_ADDONS_TEXTDOMAIN),
                    'img-on-left' => esc_html__('Image/Icon On Left', SA_EL_ADDONS_TEXTDOMAIN),
                    'img-on-right' => esc_html__('Image/Icon On Right', SA_EL_ADDONS_TEXTDOMAIN),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Image or Icon', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                'options' => [
                    'none' => [
                    ...
                    'number' => [
                        'title' => esc_html__('Number', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Infobox Content', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        $this->add_control(
            'sa_el_infobox_title',
            [
                'label' => esc_html__('Infobox Title', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'dynamic' => [
                    'active' => true
                ],
                'default' => esc_html__('This is an info box', SA_EL_ADDONS_TEXTDOMAIN)
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Write a short description, that will describe the title or something informational and useful.', SA_EL_ADDONS_TEXTDOMAIN),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Infobox Button', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Infobox Clickable', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'label_on' => __('Yes', SA_EL_ADDONS_TEXTDOMAIN),
                'label_off' => __('No', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Infobox Link', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'placeholder' => __('Enter link URL for the button', SA_EL_ADDONS_TEXTDOMAIN),
                'show_external' => true,
                'default' => [
                    'url' => '#'
                ],
                'title' => __('Enter heading for the button', SA_EL_ADDONS_TEXTDOMAIN),
                'condition' => [
                    'sa_el_show_infobox_button' => 'yes'
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Image Shape', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'square',
                'label_block' => false,
                'options' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Number Icon Style', SA_EL_ADDONS_TEXTDOMAIN),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'sa_el_infobox_img_or_icon' => 'number'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Icon Background Size', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 90,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Shape', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'label_block' => false,
                'options' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Button Styles', SA_EL_ADDONS_TEXTDOMAIN),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'sa_el_show_infobox_button' => 'yes'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Content Only Margin', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Content Only Background', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Content Only Padding', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'default' => ['50'],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Content Color', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__('Transition will applied to ms (ex: 300ms).', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            '_section_style',
            [
                'label' => esc_html__('Info Box Advanced', SA_EL_ADDONS_TEXTDOMAIN),
