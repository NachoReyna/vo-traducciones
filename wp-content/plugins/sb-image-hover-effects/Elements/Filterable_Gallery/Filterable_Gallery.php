...
namespace SA_EL_ADDONS\Elements\Filterable_Gallery;
...
class Filterable_Gallery extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Filterable Gallery', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Items to show', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Animation Duration (ms)', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => 500,
                ]
        ...
        $this->add_control(
                ...
                [
                    ...
                    'default' => 'grid',
                    'options' => [
                        'grid' => esc_html__('Grid', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Image Height', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => '300',
                    'condition' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Caption Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'hoverer',
                    'options' => [
                        'hoverer' => __('Overlay', SA_EL_ADDONS_TEXTDOMAIN),
                        'card' => __('Card', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Hover Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'sa_el_slide_up',
                    'options' => [
                        'sa_el_none' => esc_html__('None', SA_EL_ADDONS_TEXTDOMAIN),
                        'sa_el_slide_up' => esc_html__('Slide In Up', SA_EL_ADDONS_TEXTDOMAIN),
                        'sa_el_fade_in' => esc_html__('Fade In', SA_EL_ADDONS_TEXTDOMAIN),
                        'sa_el_zoom_in' => esc_html__('Zoom In ', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    'condition' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Hover Transition', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                'sa_el_fg_show_popup',
                [
                    'label' => esc_html__('Link to', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'buttons',
                    'options' => [
                        'none' => esc_html__('None', SA_EL_ADDONS_TEXTDOMAIN),
                        'media' => esc_html__('Media', SA_EL_ADDONS_TEXTDOMAIN),
                        'buttons' => esc_html__('Buttons', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Lightbox Icon', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Link Icon', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::ICON,
                    'default' => 'fa fa-link',
                    'condition' => [
                        'sa_el_fg_show_popup' => 'buttons',
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Filterable Controls', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
                'filter_enable',
                [
                    'label' => __('Enable Filter', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Gallery All Label', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => 'All Item',
                    'condition' => [
                        'filter_enable' => 'yes',
                ...
                [
                    ...
                    'fields' => [
                        [
                            ...
                            'type' => Controls_Manager::TEXT,
                            'label_block' => true,
                            'default' => esc_html__('Gallery Item', SA_EL_ADDONS_TEXTDOMAIN),
                        ],
                    ],
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Gallery Items', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
                'photo_gallery',
                [
                    'label' => __('Enable Photo Gallery', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes',
                    'frontend_available' => true,
                ]
                ...
                [
                    ...
                    'fields' => [
                        [
                            ...
                            'label' => __('Video Gallery?', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SWITCHER,
                            'default' => 'false',
                        ...
                        [
                            ...
                            'label' => esc_html__('Video Link', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXT,
                            'label_block' => true,
                        ...
                        [
                            ...
                            'label' => esc_html__('Control Name', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXT,
                            'label_block' => true,
                            'default' => '',
                            'description' => __('Use the gallery control name from Control Settings. Separate multiple items with comma (e.g. <strong>Gallery Item, Gallery Item 2</strong>)', SA_EL_ADDONS_TEXTDOMAIN),
                        ],
                        [
                            'name' => 'sa_el_fg_gallery_item_name',
                            'label' => esc_html__('Item Name', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXT,
                            'label_block' => true,
                            'default' => esc_html__('Gallery item name', SA_EL_ADDONS_TEXTDOMAIN),
                        ],
                        [
                            'name' => 'sa_el_fg_gallery_item_content',
                            'label' => esc_html__('Item Content', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXTAREA,
                            'label_block' => true,
                            'default' => esc_html__('Consectetur adipisicing elit. Lorem ipsum dolor sit amet,  Quidem, provident.', SA_EL_ADDONS_TEXTDOMAIN),
                        ],
                        [
                        ...
                        [
                            ...
                            'label' => __('Gallery Lightbox Button?', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SWITCHER,
                            'default' => 'true',
                            'label_on' => esc_html__('Yes', SA_EL_ADDONS_TEXTDOMAIN),
                            'label_off' => esc_html__('No', SA_EL_ADDONS_TEXTDOMAIN),
                        ...
                        [
                            ...
                            'label' => __('Gallery Link Button?', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SWITCHER,
                            'default' => 'true',
                            'label_on' => esc_html__('Yes', SA_EL_ADDONS_TEXTDOMAIN),
                            'label_off' => esc_html__('No', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
                'section_pagination',
                [
                    'label' => __('Load More Button', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
                'images_per_page',
                [
                    'label' => __('Images Per Page', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => 6,
                    'condition' => [
                        'pagination' => 'yes',
        ...
        $this->add_control(
                'nomore_items_text',
                [
                    'label' => __('No More Items Text', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => __('No more items!', SA_EL_ADDONS_TEXTDOMAIN),
                    'condition' => [
                        'pagination' => 'yes',
                    ],
                ]
        ...
        $this->add_control(
                ...
                [
                    ...
                    'default' => 'after',
                    'options' => [
                        'after' => __('After', SA_EL_ADDONS_TEXTDOMAIN),
                        'before' => __('Before', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    'condition' => [
                        'pagination' => 'yes',
                    ],
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Control Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        $this->add_responsive_control(
        ...
        // Normal State Tab
        $this->start_controls_tab('sa_el_fg_control_normal', ['label' => esc_html__('Normal', SA_EL_ADDONS_TEXTDOMAIN)]);
        ...
        // Active State Tab
        $this->start_controls_tab('sa_el_cta_btn_hover', ['label' => esc_html__('Active', SA_EL_ADDONS_TEXTDOMAIN)]);
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Item Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Item Hover Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'sa_el_fg_caption_style' => 'hoverer',
                    ],
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Content Typography', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
        );
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Video item hover', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Background transition', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => ['px'],
                    'default' => [
                        'px' => 350,
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Hover icon scale', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => '1.1',
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Icon transition', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => ['px'],
                    'default' => [
                        'px' => 350,
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Item Card Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'sa_el_fg_caption_style' => 'card',
                    ],
        ...
        $this->add_responsive_control(
                'button_margin_top',
                [
                    'label' => __('Top Spacing', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
    ...
    protected function render_filters() {
        ...
        $all_text = ($settings['sa_el_fg_all_label_text'] != '') ? $settings['sa_el_fg_all_label_text'] : esc_html__('All', SA_EL_ADDONS_TEXTDOMAIN);
        ...
        if ($settings['filter_enable'] == 'yes') {
            ...
            <div class="sa_el_filter_gallery_control">
                <ul>
                    ...
                    <?php
                    foreach ($settings['sa_el_fg_controls'] as $key => $control) :
    ...
    protected function render() {
        ...
        $no_more_items_text = esc_html__($settings['nomore_items_text'], SA_EL_ADDONS_TEXTDOMAIN);
