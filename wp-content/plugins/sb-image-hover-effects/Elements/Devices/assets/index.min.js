...
var SADevices = function ($scope, $) {

    SADevices.elementSettings = sa.getElementSettings($scope);

    var $wrapper = $scope.find('.sa-el-device-wrapper'),
            $device = $scope.find('.sa-el-device'),
            $shape = $scope.find('.sa-el-device__shape'),
            url = null,
            svg = null;
    SADevices.init = function () {
        if (!SADevices.elementSettings.device_type) {
            SADevices.elementSettings.device_type = 'phone';
        }
...
jQuery(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
            "frontend/element_ready/sa_el_devices.default",
            SADevices
            );
});
