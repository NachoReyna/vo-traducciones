...
namespace SA_EL_ADDONS\Elements\Dual_Button;
...
class Dual_Button extends Widget_Base
{
    ...
    {
        return __('Dual Button', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            '_section_button',
            [
                'label' => __('Dual Buttons', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_tab(
            '_tab_button_left',
            [
                'label' => __('Left', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __('Connector', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hide Connector?', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Hide', SA_EL_ADDONS_TEXTDOMAIN),
                'label_off' => __('Show', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Connector Type', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'text' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Text', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::TEXT,
                'default' => __('Or', SA_EL_ADDONS_TEXTDOMAIN),
                'condition' => [
                    'button_connector_hide!' => 'yes',
        ...
        $this->start_controls_tab(
            '_tab_button_right',
            [
                'label' => __('Right', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Common', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
            'button_gap',
            [
                'label' => __('Space Between Buttons', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
        ...
        $this->add_control(
            'button_align_x',
            [
                'label' => __('Horizontal Alignment', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'flex-start' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Only works when buttons have different height', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'flex-start' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Left Button', SA_EL_ADDONS_TEXTDOMAIN),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => __('Connector is hidden now, please enable connector from Content > Connector tab.', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Right Button', SA_EL_ADDONS_TEXTDOMAIN),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
