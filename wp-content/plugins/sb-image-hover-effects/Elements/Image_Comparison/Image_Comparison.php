...
namespace SA_EL_ADDONS\Elements\Image_Comparison;
...
class Image_Comparison extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Image Comparison', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Images', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );

        $this->add_control(
                'before_image_label', [
            'label' => __('Label Before', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'default' => 'Before',
            'title' => __('Input before image label', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );

        $this->add_control(
                'before_image', [
            'label' => __('Choose Before Image', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                'before_image_alt', [
            'label' => __('Before Image ALT Tag', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'default' => '',
        ...
        $this->add_control(
                'after_image_label', [
            'label' => __('Label After', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'default' => 'After',
            'title' => __('Input after image label', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        $this->add_control(
                'after_image', [
            'label' => __('Choose After Image', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::MEDIA,
            'default' => [
                'url' => Utils::get_placeholder_image_src(),
            ],
        ...
        $this->add_control(
                'after_image_alt', [
            'label' => __('After Image ALT Tag', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'default' => '',
            'placeholder' => __('Enter alter tag for the image', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Original Image Visibility', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Orientation', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Wants Overlay ?', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Move Slider On Hover', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => __('yes', SA_EL_ADDONS_TEXTDOMAIN),
            'label_off' => __('no', SA_EL_ADDONS_TEXTDOMAIN),
            'default' => 'no',
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Move Slider On Click', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => __('yes', SA_EL_ADDONS_TEXTDOMAIN),
            'label_off' => __('no', SA_EL_ADDONS_TEXTDOMAIN),
            'default' => 'no',
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Image Container Styles', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
            ...
            'label' => __('Container Max Width', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 80,
                'unit' => '%',
        ...
        $this->start_controls_section(
            ...
            'label' => __('Handle', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->start_controls_tab(
                'tab_label_before', [
            'label' => __('Before', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->start_controls_tab(
                'tab_label_after', [
            'label' => __('After', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
