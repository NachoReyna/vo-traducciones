...
//
        if (($settings['sa_el_instafeed_pagination'] == 'yes')) {
            echo '<div class="sa-el-load-more-button-wrap">
                <button class="sa-el-load-more-button" data-id="' . $this->get_id() . '" data-settings=\'' . json_encode($settings_var) . '\' data-page="0"  data-class="SA_EL_ADDONS\Elements\Instagram_Feed\Files\Instagram_Query"  data-function="__ajax_template">
