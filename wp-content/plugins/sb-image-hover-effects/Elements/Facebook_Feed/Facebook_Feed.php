    ...
    protected function render()
    {
        ...
        if (($settings['show_load_more'] == 'yes')) {
            echo '<div class="sa-el-load-more-button-wrap">
                <button class="sa-el-load-more-button" id="sa-el-load-more-btn-' . $this->get_id() . '" data-settings=\'' . json_encode($settings_var) . '\' data-page="0"  data-class="SA_EL_ADDONS\Elements\Facebook_Feed\Files\Facebook_Query"  data-function="__ajax_template">
