var SAElFacebookFeed = function($scope, $) {
    ...
    $(".sa-el-load-more-button", $scope).on("click", function(e) {
        e.preventDefault();
        var $this = $(this);
