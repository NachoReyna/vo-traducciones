...
class Table extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'fields' => [
                [
                    ...
                    'label_block' => false,
                    'options' => [
                        'row' => esc_html__('Row', SA_EL_ADDONS_TEXTDOMAIN),
                        'col' => esc_html__('Column', SA_EL_ADDONS_TEXTDOMAIN),
                    ]
                ],
                [
                ...
                [
                    ...
                    'options' => [
                        'textarea' => [
                            'title' => esc_html__('Textarea', SA_EL_ADDONS_TEXTDOMAIN),
                            'icon' => 'fa fa-text-width',
                        ],
                        'editor' => [
                            'title' => esc_html__('Editor', SA_EL_ADDONS_TEXTDOMAIN),
                            'icon' => 'fa fa-pencil',
                        ],
                        'template' => [
                            'title' => esc_html__('Templates', SA_EL_ADDONS_TEXTDOMAIN),
                            'icon' => 'fa fa-file',
                        ]
                    ],
                    'default' => 'textarea',
        ...
        $this->add_control(
            ...
            'label' => __('Enable Responsive Table', SA_EL_ADDONS_TEXTDOMAIN),
            'description' => esc_html__('If enabled, table header will be automatically responsive for mobile.', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', SA_EL_ADDONS_TEXTDOMAIN),
            'label_off' => esc_html__('No', SA_EL_ADDONS_TEXTDOMAIN),
            'return_value' => 'yes',
