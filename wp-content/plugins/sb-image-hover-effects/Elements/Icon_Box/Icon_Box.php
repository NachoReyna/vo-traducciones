...
namespace SA_EL_ADDONS\Elements\Icon_Box;
...
class Icon_Box extends Widget_Base {
    ...
    public function get_title() {
        return __('Icon Box', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'label_block' => true,
            'default' => __('Your Icon Box', SA_EL_ADDONS_TEXTDOMAIN),
            'placeholder' => __('Type Icon Box Title', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'placeholder' => __('Type Icon Badge Text', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );

        $this->add_control(
                'link', [
            'label' => __('Box Link', SA_EL_ADDONS_TEXTDOMAIN),
            'separator' => 'before',
        ...
        $this->add_control(
                'icon_bg_rotate', [
            'label' => __('Rotate Icon Box', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['deg'],
            'default' => [
                'unit' => 'deg',
