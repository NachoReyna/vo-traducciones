...
namespace SA_EL_ADDONS\Elements\Pricing_Table;
...
class Pricing_Table extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Pricing Table', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Settings', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Pricing Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'label_block' => false,
                    'options' => [
                        'style-1' => esc_html__('Default', SA_EL_ADDONS_TEXTDOMAIN),
                        'style-2' => esc_html__('Pricing Style 2', SA_EL_ADDONS_TEXTDOMAIN),
                        'style-3' => esc_html__('Pricing Style 3 ' . (apply_filters(SA_EL_ADDONS_TEXTDOMAIN . '/check_version', TRUE) == FALSE ? 'Pro Only' : ''), SA_EL_ADDONS_TEXTDOMAIN),
                        'style-4' => esc_html__('Pricing Style 4 ' . (apply_filters(SA_EL_ADDONS_TEXTDOMAIN . '/check_version', TRUE) == FALSE ? 'Pro Only' : ''), SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('List Icon', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    ...
                    'label_block' => false,
                    'default' => esc_html__('Basic Plan', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Sub Title', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => esc_html__('A tagline here.', SA_EL_ADDONS_TEXTDOMAIN),
                    'condition' => [
        ...
        if (apply_filters(SA_EL_ADDONS_TEXTDOMAIN . '/check_version', TRUE)) {
            ...
            $this->add_control(
                    ...
                    [
                        'label' => esc_html__('Header Image', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => esc_html__('99', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        $this->add_control(
                'sa_el_pricing_table_onsale',
                [
                    'label' => __('On Sale?', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'no',
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Sale Price', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => esc_html__('89', SA_EL_ADDONS_TEXTDOMAIN),
                    'condition' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Price Currency', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Currency Placement', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'left',
                    'label_block' => false,
                    'options' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Pricing Position', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'bottom',
                    'label_block' => false,
                    'options' => [
                        'top' => esc_html__('On Top', SA_EL_ADDONS_TEXTDOMAIN),
                        'bottom' => esc_html__('At Bottom', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    'condition' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Price Period (per)', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => esc_html__('month', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Period Separator', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => esc_html__('/', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Feature', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
                ...
                [
                    ...
                    'fields' => [
                        [
                            ...
                            'label' => esc_html__('List Item', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXT,
                            'label_block' => true,
                            'default' => esc_html__('Pricing table list item', SA_EL_ADDONS_TEXTDOMAIN)
                        ],
                        [
                        ...
                        [
                            ...
                            'label' => esc_html__('Item Active?', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SWITCHER,
                            'return_value' => 'yes',
                            'default' => 'yes'
                        ],
                        ...
                        [
                            ...
                            'label' => esc_html__('Enable Tooltip?', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SWITCHER,
                            'return_value' => 'yes',
                            'default' => false
                        ],
                        [
                            ...
                            'label' => esc_html__('Tooltip Content', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXTAREA,
                            'default' => __("I'm a awesome tooltip!!", SA_EL_ADDONS_TEXTDOMAIN),
                            'condition' => [
                        ...
                        [
                            ...
                            'label' => esc_html__('Tooltip Side', SA_EL_ADDONS_TEXTDOMAIN),
                        ...
                        [
                            ...
                            'label' => esc_html__('Tooltip Trigger', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SELECT2,
                            'options' => [
                                'hover' => __('Hover', SA_EL_ADDONS_TEXTDOMAIN),
                                'click' => __('Click', SA_EL_ADDONS_TEXTDOMAIN),
                            ],
                            'default' => 'hover',
                            'condition' => [
                                'sa_el_pricing_item_tooltip' => 'yes'
                        ...
                        [
                            ...
                            'label' => esc_html__('Animation Duration', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::TEXT,
                            'default' => 300,
                            'condition' => [
                                'sa_el_pricing_item_tooltip' => 'yes'
                        ...
                        [
                            ...
                            'label' => esc_html__('Tooltip Arrow', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SWITCHER,
                            'return_value' => 'yes',
                            'default' => 'yes',
                            'condition' => [
                        ...
                        [
                            ...
                            'label' => esc_html__('Tooltip Theme', SA_EL_ADDONS_TEXTDOMAIN),
                            'type' => Controls_Manager::SELECT2,
                            'options' => [
                                'default' => __('Default', SA_EL_ADDONS_TEXTDOMAIN),
                                'noir' => __('Noir', SA_EL_ADDONS_TEXTDOMAIN),
                                'light' => __('Light', SA_EL_ADDONS_TEXTDOMAIN),
                                'punk' => __('Punk', SA_EL_ADDONS_TEXTDOMAIN),
                                'shadow' => __('Shadow', SA_EL_ADDONS_TEXTDOMAIN),
                                'borderless' => __('Borderless', SA_EL_ADDONS_TEXTDOMAIN),
                            ],
                            'default' => 'noir',
                            'condition' => [
                                'sa_el_pricing_item_tooltip' => 'yes'
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Footer', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'default' => esc_html__('Choose Plan', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Ribbon', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Featured?', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Ribbon Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'ribbon-1',
                    'options' => [
                        'ribbon-1' => esc_html__('Style 1', SA_EL_ADDONS_TEXTDOMAIN),
                        'ribbon-2' => esc_html__('Style 2', SA_EL_ADDONS_TEXTDOMAIN),
                        'ribbon-3' => esc_html__('Style 3', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    'condition' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Featured Tag Text', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => false,
                    'default' => esc_html__('Featured', SA_EL_ADDONS_TEXTDOMAIN),
                    'selectors' => [
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Pricing Table Style', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Line Color', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#dbdbdb',
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Subtitle Style', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'sa_el_pricing_table_style!' => 'style-1'
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Pricing', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Original Price', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'sa_el_pricing_table_onsale' => 'yes'
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Currency', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before'
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Pricing Period', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before'
                ]
        );
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Feature List', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Disable item color', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Line Height', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 3
                    ],
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Font Size', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 10
                    ],
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Arrow Background', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#3d3d3d',
                    'selectors' => [
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => 'px',
                    'description' => __('Refresh your browser after saving the padding value for see changes.', SA_EL_ADDONS_TEXTDOMAIN),
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Arrow Size', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'max' => 45,
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Icon Settings', SA_EL_ADDONS_TEXTDOMAIN),
                    'tab' => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'sa_el_pricing_table_style' => 'style-2'
                    ]
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Show Background', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes',
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Background Hover Color', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Icon Area Width', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 80
                    ],
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Icon Area Height', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 80
                    ],
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Icon Alignment', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 80
                    ],
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('Icon Hover Color', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
        ...
        // Normal State Tab
        $this->start_controls_tab('sa_el_pricing_table_btn_normal', ['label' => esc_html__('Normal', SA_EL_ADDONS_TEXTDOMAIN)]);
        ...
        // Hover State Tab
        $this->start_controls_tab('sa_el_pricing_table_btn_hover', ['label' => esc_html__('Hover', SA_EL_ADDONS_TEXTDOMAIN)]);
    ...
    protected function render() {
        ...
        <?php if ('style-1' === $settings['sa_el_pricing_table_style']) : ?>
            ...
            <?php
            if ('yes' != $settings['sa_el_pricing_table_icon_bg_show']) : echo 'none';
            endif;
            ...
            <?php if ('left' == $settings['sa_el_pricing_table_button_icon_alignment']) : ?>
                ...
                <?php echo $settings['sa_el_pricing_table_btn']; ?>
                        ...
                        <?php endif; ?>
                        <?php if ('style-3' === $settings['sa_el_pricing_table_style'] && apply_filters(SA_EL_ADDONS_TEXTDOMAIN . '/check_version', TRUE)) : ?>
            ...
            <?php if ('left' == $settings['sa_el_pricing_table_button_icon_alignment']) : ?>
                ...
                <?php echo $settings['sa_el_pricing_table_btn']; ?>
                    <?php elseif ('right' == $settings['sa_el_pricing_table_button_icon_alignment']) : ?>
                        ...
                        <?php endif; ?>
                        <?php if ('style-4' === $settings['sa_el_pricing_table_style'] && apply_filters(SA_EL_ADDONS_TEXTDOMAIN . '/check_version', TRUE)) : ?>
