...
namespace SA_EL_ADDONS\Elements\Card;
...
class Card extends Widget_Base
{
    ...
    {
        return __('Card', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            '_section_image',
            [
                'label' => __('Image & Badge', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            'image_position',
            [
                'label' => __('Image Position', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            'badge_text',
            [
                'label' => __('Badge Text', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::TEXT,
                'default' => __('Badget Text', SA_EL_ADDONS_TEXTDOMAIN),
                'placeholder' => __('Type badge text', SA_EL_ADDONS_TEXTDOMAIN),
                'separator' => 'before',
                'description' => __('Set badget position and control all the style settings from Style tab', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __('Your Card Title', SA_EL_ADDONS_TEXTDOMAIN),
                'placeholder' => __('Type Card Title', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Your card description goes here', SA_EL_ADDONS_TEXTDOMAIN),
                'placeholder' => __('Type card description', SA_EL_ADDONS_TEXTDOMAIN),
                'rows' => 5
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('Button Text', SA_EL_ADDONS_TEXTDOMAIN),
                'placeholder' => __('Type button text here', SA_EL_ADDONS_TEXTDOMAIN),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'before' => [
                        'title' => __('Before', SA_EL_ADDONS_TEXTDOMAIN),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'after' => [
                        'title' => __('After', SA_EL_ADDONS_TEXTDOMAIN),
                        'icon' => 'eicon-h-align-right',
                    ],
                ],
                'default' => 'before',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'middle-left'  => __('Middle Left', SA_EL_ADDONS_TEXTDOMAIN),
                    'middle-center'  => __('Middle Center', SA_EL_ADDONS_TEXTDOMAIN),
                    'middle-right'  => __('Middle Right', SA_EL_ADDONS_TEXTDOMAIN),
