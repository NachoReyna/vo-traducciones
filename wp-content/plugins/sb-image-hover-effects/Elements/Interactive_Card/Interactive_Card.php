...
namespace SA_EL_ADDONS\Elements\Interactive_Card;
...
class Interactive_Card extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Interactive Card', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Interactive Card', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
            ...
            'label_block' => false,
            'options' => [
                'text-card' => esc_html__('Text Card', SA_EL_ADDONS_TEXTDOMAIN),
                'img-card' => esc_html__('Image Card', SA_EL_ADDONS_TEXTDOMAIN),
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Card Type', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'default' => 'img-grid',
            'label_block' => false,
            'options' => [
                'img-grid' => esc_html__('Image Grid', SA_EL_ADDONS_TEXTDOMAIN),
                'scrollable' => esc_html__('Scrollable Content', SA_EL_ADDONS_TEXTDOMAIN),
                'video' => esc_html__('Video', SA_EL_ADDONS_TEXTDOMAIN),
            ],
                ]
        );
        ...
        // Front Panel Tab
        $this->start_controls_tab('front-panel', ['label' => esc_html__('Front Panel', SA_EL_ADDONS_TEXTDOMAIN)]);
        $this->add_control(
                'sa_el_interactive_card_front_panel_counter', [
            'label' => esc_html__('Counter', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => false,
            'default' => esc_html__('1', SA_EL_ADDONS_TEXTDOMAIN),
            'dynamic' => ['active' => true],
            'condition' => [
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::TEXT,
            'label_block' => false,
            'default' => esc_html__('Interactive Cards', SA_EL_ADDONS_TEXTDOMAIN),
            'condition' => [
                'sa_el_interactive_card_style' => 'text-card',
            ],
            'dynamic' => ['active' => true]
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Cover Image', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::TEXT,
            'label_block' => false,
            'default' => esc_html__('More', SA_EL_ADDONS_TEXTDOMAIN),
            'condition' => [
                'sa_el_interactive_card_style' => 'text-card',
            ]
                ]
        ...
        // Rear Panel Tab
        $this->start_controls_tab('rear-panel', ['label' => esc_html__('Rear Panel', SA_EL_ADDONS_TEXTDOMAIN)]);
        $this->add_control(
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Image Alignment', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'default' => 'top',
            'label_block' => false,
            'options' => [
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'default' => esc_html__('Cool Headline', SA_EL_ADDONS_TEXTDOMAIN),
            'condition' => [
                'sa_el_interactive_card_type' => 'img-grid'
            ],
            'dynamic' => ['active' => true]
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Youtube URL', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => false,
            'default' => esc_html__('https://www.youtube.com/watch?v=BhgngA_cF1c', SA_EL_ADDONS_TEXTDOMAIN),
            'condition' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Allow Full Screen?', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Animation Settings', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );

        $this->add_control(
                'sa_el_interactive_card_content_animation', [
            'label' => esc_html__('Content Animation', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'default' => 'content-show',
            'label_block' => false,
            'options' => [
                'content-show' => esc_html__('Appear', SA_EL_ADDONS_TEXTDOMAIN),
                'slide-in-left' => esc_html__('SlideInLeft', SA_EL_ADDONS_TEXTDOMAIN),
                'slide-in-right' => esc_html__('SlideInRight', SA_EL_ADDONS_TEXTDOMAIN),
                'slide-in-swing-left' => esc_html__('SlideInSwingLeft', SA_EL_ADDONS_TEXTDOMAIN),
                'slide-in-swing-right' => esc_html__('SlideInSwingRight', SA_EL_ADDONS_TEXTDOMAIN),
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Timing (ms)', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'label_block' => false,
            'default' => 400
                ]
        ...
        $this->add_responsive_control(
            ...
            'label' => esc_html__('Max Width', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 100,
                'unit' => '%',
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Small Overlay Circle', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
            'default' => '',
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Large Overlay Circle', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
            'default' => '',
            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Front Panel Style', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'label' => esc_html__('Front Content Width', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 100,
                'unit' => '%',
        ...
        $this->add_responsive_control(
            ...
            'label' => esc_html__('Front Content Height', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 100,
                'unit' => '%',
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Rear Panel Style', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Front Panel Color &amp; Typography', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
            'condition' => [
                'sa_el_interactive_card_style' => 'text-card'
            ]
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Counter Style', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Rear Panel Color &amp; Typography', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
            'condition' => [
                'sa_el_interactive_card_type!' => 'scrollable'
            ]
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Front Panel Button Style', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
            'condition' => [
                'sa_el_interactive_card_style' => 'text-card'
            ]
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Button Style ( Front Panel )', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
            'condition' => [
                'sa_el_interactive_card_style' => 'text-card'
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Rear Panel Button Style', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
            'condition' => [
                'sa_el_interactive_card_type' => 'img-grid'
            ]
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Button Style ( Rear Panel )', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
            'condition' => [
                'sa_el_interactive_card_style' => 'text-card'
        ...
        // Normal State Tab
        $this->start_controls_tab('sa_el_interactive_card_rear_btn_normal', ['label' => esc_html__('Normal', SA_EL_ADDONS_TEXTDOMAIN)]);
        ...
        // Hover State Tab
        $this->start_controls_tab('sa_el_interactive_card_rear_btn_hover', ['label' => esc_html__('Hover', SA_EL_ADDONS_TEXTDOMAIN)]);
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Close Button Style', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Vertical', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 15
            ],
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Horizontal', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 15
            ],
