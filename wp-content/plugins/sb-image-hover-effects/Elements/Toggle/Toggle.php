...
namespace SA_EL_ADDONS\Elements\Toggle;
...
class Toggle extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Content Toggle', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
                'section_primary', [
            'label' => __('Primary', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => __('Limited', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => __('Limited Content', SA_EL_ADDONS_TEXTDOMAIN),
            'condition' => [
        ...
        $this->start_controls_section(
                'section_secondary', [
            'label' => __('Secondary', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => __('Label', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::TEXT,
            'default' => __('Unlimited', SA_EL_ADDONS_TEXTDOMAIN),
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => __('Content', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::WYSIWYG,
            'default' => __('Unlimited Content', SA_EL_ADDONS_TEXTDOMAIN),
            'condition' => [
        ...
        $this->start_controls_section(
            ...
            'label' => __('Switch', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
                'switch_style', [
            'label' => __('Switch Style', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'round' => __('Round', SA_EL_ADDONS_TEXTDOMAIN),
                'rectangle' => __('Rectangle', SA_EL_ADDONS_TEXTDOMAIN),
            ],
            'default' => 'round',
                ]
        );
        ...
        $this->add_responsive_control(
                'toggle_switch_size', [
            'label' => __('Switch Size', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
            ...
            'label' => __('Headings Spacing', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 15,
                'unit' => 'px',
        ...
        $this->add_control(
            ...
            'label' => __('Controller', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        if (apply_filters(SA_EL_ADDONS_TEXTDOMAIN . '/check_version', TRUE) == FALSE) {
            $this->start_controls_section(
                    'sa_el_section_pro', [
                'label' => __('Go Premium for More Features', SA_EL_ADDONS_TEXTDOMAIN)
                    ]
            );

            $this->add_control(
                    'sa_el_control_get_pro', [
                'label' => __('Unlock more possibilities', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    '1' => [
                ...
                'default' => '1',
                'description' => '<span class="pro-feature"> Get the  <a href="https://www.oxilab.org/downloads/elementor-addons/" target="_blank">Pro version</a> for more stunning elements and customization options.</span>'
                    ]
            );
        ...
        $this->add_control(
            ...
            'label' => __('Active Text Color', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
            'default' => '',
            'selectors' => [
