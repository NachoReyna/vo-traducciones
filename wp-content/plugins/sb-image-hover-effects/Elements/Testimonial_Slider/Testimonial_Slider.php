...
namespace SA_EL_ADDONS\Elements\Testimonial_Slider;
...
class Testimonial_Slider extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Testimonial Slider', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Testimonial Content', SA_EL_ADDONS_TEXTDOMAIN)
                ]
        );
        ...
        $this->add_control(
            ...
            'fields' => [
                [
                    ...
                    'label' => esc_html__('Display Avatar?', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes',
                ],
                [
                    'name' => 'sa_el_testimonial_image',
                    'label' => esc_html__('Testimonial Avatar', SA_EL_ADDONS_TEXTDOMAIN),
                ...
                [
                    ...
                    'label' => esc_html__('User Name', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__('John Doe', SA_EL_ADDONS_TEXTDOMAIN),
                    'dynamic' => ['active' => true]
                ],
                [
                    'name' => 'sa_el_testimonial_company_title',
                    'label' => esc_html__('Company Name', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__('Codetic', SA_EL_ADDONS_TEXTDOMAIN),
                    'dynamic' => ['active' => true]
                ],
                [
                    'name' => 'sa_el_testimonial_description',
                    'label' => esc_html__('Testimonial Description', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::WYSIWYG,
                    'default' => esc_html__('"Lorem ipsum dolor sit amet, consectetur adipiscing elit,', SA_EL_ADDONS_TEXTDOMAIN),
                ],
                [
                    'name' => 'sa_el_testimonial_enable_rating',
                    'label' => esc_html__('Display Rating?', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes',
                ],
                [
                    'name' => 'sa_el_testimonial_rating_number',
                    'label' => __('Rating Number', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'rating-five',
                    'options' => [
                        'rating-one' => __('1', SA_EL_ADDONS_TEXTDOMAIN),
                        'rating-two' => __('2', SA_EL_ADDONS_TEXTDOMAIN),
                        'rating-three' => __('3', SA_EL_ADDONS_TEXTDOMAIN),
                        'rating-four' => __('4', SA_EL_ADDONS_TEXTDOMAIN),
                        'rating-five' => __('5', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    'condition' => [
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Testimonial Styles', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => __('Select Style', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'default' => 'default-style',
            'options' => [
                'default-style' => __('Default', SA_EL_ADDONS_TEXTDOMAIN),
                'classic-style' => __('Classic', SA_EL_ADDONS_TEXTDOMAIN),
                'middle-style' => __('Content | Icon/Image | Bio', SA_EL_ADDONS_TEXTDOMAIN),
                'icon-img-left-content' => __('Icon/Image | Content', SA_EL_ADDONS_TEXTDOMAIN),
                'icon-img-right-content' => __('Content | Icon/Image', SA_EL_ADDONS_TEXTDOMAIN),
                'content-top-icon-title-inline' => __('Content Top | Icon Title Inline', SA_EL_ADDONS_TEXTDOMAIN),
                'content-bottom-icon-title-inline' => __('Content Bottom | Icon Title Inline', SA_EL_ADDONS_TEXTDOMAIN)
            ]
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Testimonial Background Color', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Set Alignment', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Display User & Company Block?', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
                ]
        );
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Testimonial Image Style', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'label' => esc_html__('Image Max Width', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 25,
                'unit' => '%',
        ...
        $this->add_responsive_control(
            ...
            'label' => esc_html__('Image Width', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 150,
                'unit' => 'px',
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Rounded Avatar?', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            'label' => __('User Name', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('User Name Color', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
            'default' => '#272727',
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => __('Company Name', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Company Color', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
            'default' => '#272727',
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => __('Testimonial Text', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Testimonial Text Color', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
            'default' => '#7a7a7a',
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => __('Quotation Mark', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Quotation Mark Color', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
