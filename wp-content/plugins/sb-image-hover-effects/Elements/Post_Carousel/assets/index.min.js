/*===================== Post Carousel================*/
var SaElPostCarouselHandler = function($scope, $) {
    var $postCarousel = $scope.find(".sa-el-post-carousel").eq(0),
        $autoplay =
    ...
    var saelPostCarousel = new Swiper($postCarousel, {
    ...
    if ($autoplay === 0) {
        saelPostCarousel.autoplay.stop();
    }
    ...
    if ($pause_on_hover && $autoplay !== 0) {
        ...
        $postCarousel.on("mouseleave", function() {
            saelPostCarousel.autoplay.start();
        });
    }
};
...
jQuery(window).on("elementor/frontend/init", function() {
    elementorFrontend.hooks.addAction(
        "frontend/element_ready/sa_el_post_carousel.default",
        SaElPostCarouselHandler
    );
});