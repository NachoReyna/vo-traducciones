...
namespace SA_EL_ADDONS\Elements\Logo_Carousel;
...
class Logo_Carousel extends Widget_Base
{
    ...
    {
        return __('Logo Carousel', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label'                 => __('Logo Carousel', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
            ...
            [
                ...
                'fields'                => [
                    [
                        ...
                        'label'       => __('Upload Logo Image', SA_EL_ADDONS_TEXTDOMAIN),
                    ...
                    [
                        'name'        => 'logo_alt',
                        'label'       => __('Alt Text', SA_EL_ADDONS_TEXTDOMAIN),
                        'type'        => Controls_Manager::TEXT,
                    ],
                    [
                        'name'        => 'link',
                ...
                'title_field'           => __('Logo Image', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->start_controls_section(
            'section_logos_style',
            [
                'label'                 => __('Logos', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_group_control(
            ...
            [
                'name'                  => 'logo_bg',
                'label'                 => __('Button Background', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            'logos_padding',
            [
                'label'                 => __('Padding Da', SA_EL_ADDONS_TEXTDOMAIN),
                'type'                  => Controls_Manager::DIMENSIONS,
                'size_units'            => ['px', '%'],
                'selectors'             => [
                    '{{WRAPPER}} .sa_el_lc_logo' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_control(
            'grayscale_normal',
            [
                'label'                 => __('Grayscale', SA_EL_ADDONS_TEXTDOMAIN),
                'type'                  => Controls_Manager::SWITCHER,
                'default'               => 'no',
                'label_on'              => __('Yes', SA_EL_ADDONS_TEXTDOMAIN),
                'label_off'             => __('No', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            'section_dots_style',
            [
                'label'                 => __('Pagination: Dots', SA_EL_ADDONS_TEXTDOMAIN),
                'tab'                   => Controls_Manager::TAB_STYLE,
                'condition'             => [
                    'dots'              => 'yes'
                ],
