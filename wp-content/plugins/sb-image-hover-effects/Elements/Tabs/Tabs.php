...
namespace SA_EL_ADDONS\Elements\Tabs;
...
class Tabs extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tabs', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'label_block' => false,
            'options' => [
                'sa_el_tabs_horizontal' => esc_html__('Horizontal', SA_EL_ADDONS_TEXTDOMAIN),
                'sa_el_tabs_vertical' => esc_html__('Vertical', SA_EL_ADDONS_TEXTDOMAIN),
            ],
                ]
        );
        $this->add_control(
                'sa_el_tabs_icon_show', [
            'label' => esc_html__('Enable Icon', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'label_block' => false,
            'options' => [
                'sa_el_tab_top_icon' => esc_html__('Stacked', SA_EL_ADDONS_TEXTDOMAIN),
                'sa_el_tab_inline_icon' => esc_html__('Inline', SA_EL_ADDONS_TEXTDOMAIN),
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            'seperator' => 'before',
            'default' => [
                ['sa_el_tabs_tab_title' => esc_html__('Your Title #', SA_EL_ADDONS_TEXTDOMAIN)],
                ['sa_el_tabs_tab_title' => esc_html__('Your Title #', SA_EL_ADDONS_TEXTDOMAIN)],
                ['sa_el_tabs_tab_title' => esc_html__('Your Title #', SA_EL_ADDONS_TEXTDOMAIN)],
            ],
            'fields' => [
                [
                    ...
                    'label' => __('Set as Default', SA_EL_ADDONS_TEXTDOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'inactive',
        ...
        $this->add_responsive_control(
            ...
            'label' => __('Title Min Width', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        // Normal State Tab
        $this->start_controls_tab('sa_el_tabs_header_normal', ['label' => esc_html__('Normal', SA_EL_ADDONS_TEXTDOMAIN)]);
        $this->add_control(
        ...
        // Hover State Tab
        $this->start_controls_tab('sa_el_tabs_header_hover', ['label' => esc_html__('Hover', SA_EL_ADDONS_TEXTDOMAIN)]);
        $this->add_control(
        ...
        $this->end_controls_tab();
        // Active State Tab
        $this->start_controls_tab('sa_el_tabs_header_active', ['label' => esc_html__('Active', SA_EL_ADDONS_TEXTDOMAIN)]);
        $this->add_control(
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Caret', SA_EL_ADDONS_TEXTDOMAIN),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        $this->add_control(
                'sa_el_tabs_tab_caret_show', [
            'label' => esc_html__('Show Caret on Active Tab', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
            'return_value' => 'yes',
                ]
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Caret Size', SA_EL_ADDONS_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 10,
            ],
