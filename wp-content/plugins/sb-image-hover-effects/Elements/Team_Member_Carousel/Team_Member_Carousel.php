...
namespace SA_EL_ADDONS\Elements\Team_Member_Carousel;
...
class Team_Member_Carousel extends Widget_Base
{
    ...
    {
        return __('Team Member Carousel', SA_EL_ADDONS_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'section_team_member',
            [
                'label' => __('Team Members', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
            ...
            [
                ...
                'fields' => [
                    [
                        ...
                        'default' => __('John Doe', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        ...
                        'default' => __('Web Developer', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        ...
                        'default' => __('Enter member description here ', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                    ...
                    [
                        ...
                        'label' => __('Social Links', SA_EL_ADDONS_TEXTDOMAIN),
                    ...
                    [
                        ...
                        'description' => __('Enter Facebook page or profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        'name' => 'twitter_url',
                        ...
                        'description' => __('Enter Twitter profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        ...
                        'description' => __('Enter Google+ profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        'name' => 'linkedin_url',
                        ...
                        'description' => __('Enter Linkedin profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        'name' => 'instagram_url',
                        ...
                        'description' => __('Enter Instagram profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        'name' => 'youtube_url',
                        ...
                        'description' => __('Enter YouTube profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        'name' => 'pinterest_url',
                        ...
                        'description' => __('Enter Pinterest profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                    [
                        'name' => 'dribbble_url',
                        ...
                        'description' => __('Enter Dribbble profile URL of team member', SA_EL_ADDONS_TEXTDOMAIN),
                    ],
                ],
        ...
        $this->add_control(
            'member_social_links',
            [
                'label' => __('Show Social Icons', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Team Member Settings', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->add_control(
            'name_html_tag',
            [
                'label' => __('Name HTML Tag', SA_EL_ADDONS_TEXTDOMAIN),
                ...
                'options' => [
                    ...
                    'div' => __('div', SA_EL_ADDONS_TEXTDOMAIN),
                    'span' => __('span', SA_EL_ADDONS_TEXTDOMAIN),
                    'p' => __('p', SA_EL_ADDONS_TEXTDOMAIN),
                ],
            ]
        );
        ...
        $this->add_control(
            'position_html_tag',
            [
                'label' => __('Position HTML Tag', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'div',
                'options' => [
                    'h1' => __('H1', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Social Icons Position', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'after_desc',
                'options' => [
                    'before_desc' => __('Before Description', SA_EL_ADDONS_TEXTDOMAIN),
                    'after_desc' => __('After Description', SA_EL_ADDONS_TEXTDOMAIN),
                ],
                'condition' => [
        ...
        $this->add_control(
            'overlay_content',
            [
                'label' => __('Overlay Content', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none' => __('None', SA_EL_ADDONS_TEXTDOMAIN),
                    'social_icons' => __('Social Icons', SA_EL_ADDONS_TEXTDOMAIN),
                    'all_content' => __('Content + Social Icons', SA_EL_ADDONS_TEXTDOMAIN),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Divider after Name', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Divider after Position', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'hide',
                'label_on' => __('Show', SA_EL_ADDONS_TEXTDOMAIN),
                'label_off' => __('Hide', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Divider after Description', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'hide',
                'label_on' => __('Show', SA_EL_ADDONS_TEXTDOMAIN),
                'label_off' => __('Hide', SA_EL_ADDONS_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Slider Settings', SA_EL_ADDONS_TEXTDOMAIN),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Pause slider when hover on slider area.', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'label_on' => __('Pause', SA_EL_ADDONS_TEXTDOMAIN),
                'label_off' => __('Play', SA_EL_ADDONS_TEXTDOMAIN),
                'return_value' => 'yes',
                'condition' => [
                    'autoplay' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            'member_image_width',
            [
                'label' => __('Image Width', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%', 'px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Divider', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
        ...
        $this->add_responsive_control(
            'name_divider_width',
            [
                'label' => __('Divider Width', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 100,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
            'name_divider_height',
            [
                'label' => __('Divider Height', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 4,
                ],
        ...
        $this->add_responsive_control(
            'member_icons_gap',
            [
                'label' => __('Icons Gap', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'default' => ['size' => 10],
                'size_units' => ['%', 'px'],
                'range' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Icons Color', SA_EL_ADDONS_TEXTDOMAIN),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
